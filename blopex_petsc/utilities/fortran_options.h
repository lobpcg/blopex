...
/* When compiling for Petsc remove comment from following
 * #include "petsc.h".  This contains definition of PetscInt.
...
/* When compiling for HYPRE remove comment from following  
 * #include "_hypre_utilities.h".  This contains a 
